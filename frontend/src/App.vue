...
async function refreshTasks() {
  tasks.value = await listVideoTasks();
}
...
async function add() {
  ...
  try {
    ...
    const events = loginEvents(attempt.id, async (event) => {
    ...
    >
      <form @submit.prevent="submitVideo">
        ...
        <div class="dialog-actions">
          <DpButton type="button" @click="showTaskDialog = false">取消</DpButton>
